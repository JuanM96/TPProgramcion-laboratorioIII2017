...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try {
            ...
            $this->_objetoPDO = new PDO('mysql:host=mysql.hostinger.com.ar;dbname=u505356375_tpjim;charset=utf8', 'u505356375_jim', 'SDqqLkV2lCD6', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
